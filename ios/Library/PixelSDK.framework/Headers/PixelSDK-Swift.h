...
SWIFT_CLASS("_TtC8PixelSDK11HKOperation")
@interface HKOperation : NSOperation
...
SWIFT_CLASS("_TtC8PixelSDK19APINetworkOperation")
@interface APINetworkOperation : HKOperation
- (void)main;
- (void)cancel;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC8PixelSDK18APIResponseHandler")
...
typedef SWIFT_ENUM(NSInteger, EventAction, open) {
  EventActionOnClick = 1,
  EventActionOnLongPress = 2,
  EventActionEditingDidBegin = 3,
  EventActionEditingChanged = 4,
  EventActionEditingDidEnd = 5,
};
...
SWIFT_CLASS("_TtC8PixelSDK14LocatorManager")
@interface LocatorManager : NSObject <CLLocationManagerDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
SWIFT_CLASS("_TtC8PixelSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(PixelSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PixelSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PixelSDK)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PixelSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PixelSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC8PixelSDK12TaskDelegate")
...
SWIFT_CLASS("_TtC8PixelSDK7Tracker")
@interface Tracker : NSObject
@property (nonatomic, weak) id <TrackerDelegate> _Nullable delegate;
...
- (BOOL)exceptionHandlerCallWithCode:(NSString * _Nonnull)code error:(NSError * _Nullable * _Nullable)error;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)setAPIKey:(NSString * _Nonnull)apiKey showLog:(BOOL)showLog addGeo:(BOOL)addGeo sendBatch:(NSTimeInterval)sendBatch waitForResponse:(NSTimeInterval)waitForResponse;
@end
...
@interface Tracker (SWIFT_EXTENSION(PixelSDK))
/// Function to get track data
/// \param sender Screen element where action is performed
///
/// \param eventAction Which event action is set
///
/// \param controller Screen where action is performed
///
/// \param characterKey Character during typing.
///
/// \param addGeo Flag to add location or not
///
- (void)trackWithSender:(id _Nonnull)sender eventAction:(enum EventAction)eventAction controller:(UIViewController * _Nonnull)controller characterKey:(NSString * _Nonnull)characterKey addGeo:(BOOL)addGeo;
- (void)trackViewsWithFreindlyN:(NSString * _Nonnull)freindlyN ObjRef:(id _Nonnull)ObjRef ViewRef:(id _Nonnull)ViewRef controller:(UIViewController * _Nonnull)controller addGeo:(BOOL)addGeo;
- (void)identifyWithEmail:(NSString * _Nonnull)email controller:(UIViewController * _Nonnull)controller addGeo:(BOOL)addGeo;
/// Function to track custom events mentioned by developer
/// \param category Category for custom events
///
/// \param action Action is set by developrt
///
/// \param lable Lable mentioned by developer
///
/// \param controller Screen where action is performed
///
/// \param addGeo Flag to add location or not
///
- (void)trackCustomWithCategory:(NSString * _Nonnull)category action:(NSString * _Nonnull)action lable:(NSString * _Nonnull)lable controller:(UIViewController * _Nonnull)controller addGeo:(BOOL)addGeo;
@end


SWIFT_PROTOCOL("_TtP8PixelSDK15TrackerDelegate_")
@protocol TrackerDelegate
- (void)displayHandlerWithResult:(NSString * _Nonnull)result;
@end
